...
[![Build Status](https://travis-ci.org/gabrysbiz/lesscss-compiler.svg?branch=release%2F1.2.2)](https://travis-ci.org/gabrysbiz/lesscss-compiler)
...
* Java 5.0 or higher
* Third-Party Dependencies ([see list](http://lesscss-compiler.projects.gabrys.biz/1.2.2/dependencies.html))

# Download
You can download the library from [this page](http://lesscss-compiler.projects.gabrys.biz/1.2.2/download.html)
or using various [dependency management tools](http://lesscss-compiler.projects.gabrys.biz/1.2.2/dependency-info.html).
